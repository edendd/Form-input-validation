...
const nameValidator = () => {
  // 1. Create a variable named `nameValue` to store the `.value` property of the `nameElement` input and log the 
  //variable out to the console — console.log("Name value is: ", `"${nameValue}"`);
...
const emailValidator = () => {
  // 1. Create a variable named `emailValue` to store the `.value` property of the `emailAddress` input and log the
  // variable out to the console — console.log("Email value is: ", `"${emailValue}"`);
...
const languageValidator = () => {
  // 1. Create a variable named `languageSectionIsValid` to store the test value for this section,
  // which is the total languages total value.
